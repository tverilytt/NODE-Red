...
//    httpRoot: '/',
    ...
    functionGlobalContext: {
      getDecryptedString : function(str) {
        var encryptedStr = decodeURIComponent(str);
        var decryptedStr = cryptico.decrypt(encryptedStr, privateKey);
        return decryptedStr;
      }
    },
...
var cryptico = require(__dirname + '/cryptico.js').cryptico;
var rsaPassphrase = 'yourpassphrase';
var publicKeyString = 'yourpublickey';

var privateKey = (function() {
   var Bits = 512;

   console.log('passphrase: ' + rsaPassphrase);
   console.log('Bit length: ' + Bits);

   return cryptico.generateRSAKey(rsaPassphrase, Bits);
})();
