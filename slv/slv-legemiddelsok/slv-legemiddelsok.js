...
var DEBUG_PREFIX = '[SLV: legemiddelsok]';
...
module.exports = function(RED) {
  ...
  function SLVLegemiddelSok(config) {
      ...
      http.get(httpOptions, function(res) {
        ...
        res.on('end', function() {
          ...
          try {
            ...
            console.log('=====> Catch SLV legemiddelsok  error:', error);
            console.log('=====> Catch SLV legemiddelsok error stack:', error.stack);
  ...
  RED.nodes.registerType('legemiddelsok', SLVLegemiddelSok);
};
